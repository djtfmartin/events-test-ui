...
class Banner extends React.Component {
    render() {
        return  <div id="wrapper-navbar" itemScope="" itemType="http://schema.org/WebSite">
            ...
            <nav className="navbar navbar-inverse navbar-expand-md">
                <div className="::containerClass:: header-logo-menu">
                    <div className="navbar-header">
                        ...
                        <div className="display-flex ::loginStatus::">
                            <button
                            ...
                            <a href="::loginURL::" role="button"
                               className="account-mobile hidden-md hidden-lg loginBtn mobile-login-btn"
                               title="Login button">
                            ...
                            <a href="::logoutURL::" role="button"
                               className="account-mobile hidden-md hidden-lg logoutBtn mobile-logout-btn"
                               title="Logout">
                                <i className="fas fa-sign-out"></i>
                            </a>
                            <button className="navbar-toggle collapsed collapse-trigger-button" type="button"
                                    data-toggle="collapse" data-target="#navbarOuterWrapper"
                                    aria-controls="navbarOuterWrapper"
                    ...
                    <div id="navbarOuterWrapper" className="outer-nav-wrapper collapse navbar-collapse">
                        <div className="top-bar hidden-xs hidden-sm">
                            ...
                            <div className="account ::loginStatus::">
                                ...
                                <a href="::loginURL::" className="btn btn-primary btn-sm loginBtn">Login</a>
                                <a href="::logoutURL::" className="btn btn-outline-white btn-sm logoutBtn"
                        ...
                        <div className="main-nav-wrapper">
                                ...
                                <ul id="main-menu" className="nav navbar-nav" role="menubar">
                                    <li itemScope="itemscope" itemType="https://www.schema.org/SiteNavigationElement"
                                        ...
                                        <a href="#" data-toggle="dropdown" aria-haspopup="true"
                                           aria-expanded="true" className="dropdown-toggle nav-link"
                                           id="menu-item-dropdown-22">Search
                                            &amp; analyse <span className="caret"></span></a>
                                        <ul className="dropdown-menu" aria-labelledby="menu-item-dropdown-22"
                                            role="menu">
                                            ...
                                            <li itemScope="itemscope"
                                                ...
                                                <a href="https://biocache.ala.org.au/search#tab_simpleSearch"
                                                   className="dropdown-item">Search &amp; download records</a></li>
                                            <li itemScope="itemscope"
                                                itemType="https://www.schema.org/SiteNavigationElement"
                                                id="menu-item-28"
                                            ...
                                            <li itemScope="itemscope"
                                                ...
                                                <a href="https://spatial.ala.org.au/"
                                                   className="dropdown-item">Spatial analysis (Spatial Portal)</a></li>
                                            <li itemScope="itemscope"
                                                itemType="https://www.schema.org/SiteNavigationElement"
                                                id="menu-item-26"
                                    ...
                                    <li itemScope="itemscope" itemType="https://www.schema.org/SiteNavigationElement"
                                        ...
                                        <ul className="dropdown-menu" aria-labelledby="menu-item-dropdown-32"
                                            role="menu">
                                            <li itemScope="itemscope"
                                                itemType="https://www.schema.org/SiteNavigationElement"
                                                id="menu-item-40773"
                                                className="menu-item menu-item-type-custom menu-item-object-custom menu-item-40773 nav-item">
                                                <a href="https://support.ala.org.au/support/solutions/articles/6000195493-how-to-submit-a-data-set"
                                            ...
                                            <li itemScope="itemscope"
                                                ...
                                                <a href="https://biocollect.ala.org.au/acsa"
                                                   className="dropdown-item">Discover citizen science projects</a></li>
                                        </ul>
                                    </li>
                                    <li itemScope="itemscope" itemType="https://www.schema.org/SiteNavigationElement"
                                        className="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children dropdown nav-item">
                                        <a href="#" data-toggle="dropdown" aria-haspopup="true"
                                           aria-expanded="false" className="dropdown-toggle nav-link">Resources
                                            <span className="caret"></span></a>
                                        <ul className="dropdown-menu" aria-labelledby="menu-item-dropdown-199"
                                            role="menu">
                                            <li itemScope="itemscope"
                                                itemType="https://www.schema.org/SiteNavigationElement"
                                            ...
                                            <li itemScope="itemscope"
                                                itemType="https://www.schema.org/SiteNavigationElement"
                                                className="menu-item menu-item-type-post_type menu-item-object-page nav-item">
                                                <a href="https://www.ala.org.au/education-resources/"
                                                   className="dropdown-item">Education
                                                    resources</a></li>
                                            <li className="menu-item menu-item-type-post_type menu-item-object-page nav-item">
                                                <a
                                                    href="https://www.ala.org.au/abdmp/">Data Mobilisation Program</a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li itemScope="itemscope" itemType="https://www.schema.org/SiteNavigationElement"
                                        ...
                                        <a href="#" data-toggle="dropdown" aria-haspopup="true"
                                           ...
                                           id="menu-item-dropdown-178">About
                                            <span className="caret"></span></a>
                                        <ul className="dropdown-menu" aria-labelledby="menu-item-dropdown-178"
                                            role="menu">
                                            <li itemScope="itemscope"
                                                itemType="https://www.schema.org/SiteNavigationElement"
                                                id="menu-item-179"
                                            ...
                                            <li itemScope="itemscope"
                                                ...
                                                <a href="https://www.ala.org.au/indigenous-ecological-knowledge/"
                                                   className="dropdown-item">Indigenous ecological knowledge</a></li>
                                            <li itemScope="itemscope"
                                                itemType="https://www.schema.org/SiteNavigationElement"
                                    ...
                                    <li itemScope="itemscope" itemType="https://www.schema.org/SiteNavigationElement"
                                        ...
                                        <a href="#" data-toggle="dropdown" aria-haspopup="true"
                                           ...
                                           id="menu-item-dropdown-41391">Help
                                            <span className="caret"></span></a>
                                        <ul className="dropdown-menu" aria-labelledby="menu-item-dropdown-41391"
                                            role="menu">
                                            <li itemScope="itemscope"
                                                itemType="https://www.schema.org/SiteNavigationElement"
                                                id="menu-item-41959"
                            ...
                            <button className="search-trigger hidden-xs hidden-sm collapsed collapse-trigger-button"
                                ...
                                <span className="collapse visible-on-show" aria-hidden="true"
                ...
                <div className="::containerClass::">
                    <div id="autocompleteSearchALA" className="collapse">
                        <form method="get" action="::searchServer::::searchPath::" className="search-form">
